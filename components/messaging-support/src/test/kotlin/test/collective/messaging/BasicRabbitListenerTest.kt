...
import io.collective.messaging.RabbitTestSupport
...
class BasicRabbitListenerTest {
    ...
    @Before
    fun before() {
        BasicRabbitConfiguration("amqp://localhost:5672","test-exchange", "test-queue", "test-key",subscribe = false, callback = null).setUp()
